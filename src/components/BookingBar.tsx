	...
	return (
		...
		<div className='absolute hidden xl:flex justify-between items-center w-11/12 p-5 bg-white shadow-black/30 shadow-lg -bottom-16 rounded-lg px-10'>
			...
			<div className='flex flex-col  justify-center gap-2'>
				...
				<Input id='startDate' placeholder='---/-----/--' booking value={formData.startDate} handleChange={handleInputChange} />
			</div>
			<div className='flex flex-col  justify-center gap-2'>
				<span className='font-bold'>Ending date</span>
				<Input id='endDate' placeholder='---/-----/--' booking value={formData.endDate} handleChange={handleInputChange} />
			</div>
			<div className='flex flex-col  justify-center  gap-2'>
